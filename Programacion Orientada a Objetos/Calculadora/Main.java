...
public class Main {
	...
	public class NoDivisible extends Exception {
	...
	public static void main(final String [] args) {
		...
		int resultado = pedirOperacion(scanner, izq, der);
	}
	...
	int suma(int izq, int der) {
		return izq + der;
	}

	int resta(int izq, int der) {
		return izq - der;
	}

	int multi(int izq, int der) {
		return izq * der;
	}

	int div(int izq, int der) {
		if (der == 0) {
